            ...
            <>
                <div className="flex flex-row h-full items-center">
                    ...
                    <div className="flex-auto w-2/6">
                        ...
                        <p className="text-white text-center">Be able to share every kind of audio with other listener.</p>
                        <div className="relative w-3/5 mx-auto">
                            ...
                            <form className={`w-full mt-2 flex flex-col gap-2`} onSubmit={login}>
                                <input type="email" className="flex-auto border h-10 rounded p-3 w-full disabled:text-gray-400 disabled:bg-gray-200 dark:bg-neutral-900 dark:text-white" placeholder="Email" onChange={handleEmail}  disabled={isLoading} />
